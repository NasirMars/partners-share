...
F_start = Decimal('10600.0')    # F先生的之前投入资金(最后更新时间：7月20日)
L_start = Decimal('1000.0')        # L先生的之前投入资金(最后更新时间：7月20日)
Z_start = Decimal('1000.0')        # Z先生的之前投入资金(最后更新时间：7月20日)
total_end = Decimal('10600.0')  # 结算资金（投资后所得）(最后更新时间：未启用)
